...
class ProfileAdmin(admin.ModelAdmin):
    list_display = ['user', 'is_seller_verified', 'is_platform_account', 'is_trusted_seller', 'rating', 'is_public', 'created']
    list_filter = ['is_seller_verified', 'is_platform_account', 'is_trusted_seller', 'is_public', 'created']
